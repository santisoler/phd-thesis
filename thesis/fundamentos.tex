...
acerca de las masas que componen nuestro planeta. Sin embargo los valores de
este campo presentan ligeras variaciones a lo largo de la Tierra, las cuales se
pueden asociar a cuerpos o densidades anómalas debajo de la superficie.
...
Si bien esta aproximación no es lo suficientemente apropiada para muchas
aplicaciones, nos provee de una descripción matemática sencilla cuyas
derivaciones poseen soluciones analíticas y son relativamente fácil de obtener.
De esta manera definiremos a la \emph{Tierra normal} como un \emph{elipsoide de
referencia}, es decir, un elipsoide de revolución que a su vez es una
superficie equipotencial del campo de gravedad que este genera.
Llamaremos $U(\mathbf{p})$ al \emph{campo de gravedad normal}, es decir, el
potencial de gravedad generado por el elipsoide de referencia y definimos al
elipsoide de referencia como la superficie equipotencial
...
Vale notar que no es fundamental definir la distribución de densidad del
elipsoide \citep[][p.~64]{heiskanen1967}. El elipsoide de referencia vendrá
definido mediante:
...
La superficie del elipsoide se describe como
...
y la superficie del elipsoide largo de la dirección normal a esta.
...
Dada la simetría de rotación del elipsoide y del hecho que el potencial
...
externo al elipsoide de referencia dada por la \emph{closed-form formula} de
\citet{li2001}.

La gravedad normal en cualquier punto situado sobre la superficie del elipsoide
de referencia ($h=0$) se puede calcular de manera sencilla a través de la
ecuación de Somigliana \citep{heiskanen1967}:
