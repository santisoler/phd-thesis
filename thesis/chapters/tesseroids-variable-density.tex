...
de segundo orden (ec.~\ref{eq:glq-var-dens}).
...
$\rho_\text{out} = 2670$~\kgpercubicm{} en los radios interno ($R_\text{in}$)
...
$\rho_\text{out} = 2670$~\kgpercubicm{} y $\rho_\text{in} = 3300$~\kgpercubicm{}
