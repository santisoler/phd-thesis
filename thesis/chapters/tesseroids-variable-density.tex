...
\emph{ratio} distancia-tamaño y delta que garantizan una precisión de 0.1\% en
relación con las soluciones analíticas.
...
Aunque los \emph{ratios} densidad-tamaño y delta pueden ser configurados
...
$\delta$ de la discretización basada en la densidad determinan cuántas veces
