...
\centering
\includegraphics[width=\linewidth]{
    figs/tesseroids-variable-density/linear-density-diffs.pdf
}
\caption{
...
\includegraphics[width=0.5\linewidth]{
    figs/tesseroids-variable-density/exponential-densities.pdf
}
\caption{
...
\centering
\includegraphics[width=\linewidth]{
    figs/tesseroids-variable-density/exponential-density-diffs.pdf
}
\caption{
...
\centering
\includegraphics[width=0.5\linewidth]{
    figs/tesseroids-variable-density/sine-densities.pdf
}
\caption{
...
\centering
\includegraphics[width=\linewidth]{
    figs/tesseroids-variable-density/sine-density-diffs.pdf
}
\caption{
...
\centering
\includegraphics[width=\linewidth]{
    figs/tesseroids-variable-density/number-of-tesseroids.pdf
}
\caption{
...
densidad de la Cuenca Neuquina de -412kg/m$^3$ y -275kg/m$^3$, respectivamente.
...
profundidad de 5014m (la región más profunda de la cuenca), con un valor de $b$
igual a 3.
...
dada por el valor medio entre -412kg/m$^3$ y -275kg/m$^3$.
...
Las Figuras~\ref{fig:neuquen-basin-diffs}a-b y ~\ref{fig:neuquen-basin-diffs}c-d
muestran las diferencias con las densidad constante y con la densidad lineal,
respectivamente.
...
Agradecemos también al editor Kosuke Heki y a dos reviewers anónimos por sus
