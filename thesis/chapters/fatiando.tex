...
\citep{sesmicunix}, cuyo desarrollo comenzó a finales de la década del 70
y está disponible bajo una licencia BSD Clause-3; \ac{GMT}
...
interactivo originalmente desarrollado para el lenguaje Python, cuyo objetivo
es facilitar la forma en la cual los usuarios y las usuarias operan con sus
datos.
...
había sido diseñado.
Debido principalmente a los beneficios que trae el lenguaje Python dados por su
sintaxis sencilla, su portabilidad, su orientación a objetos entre otros
atributos, estas herramientas comenzaron a ser utilizadas dentro de diferentes
ámbitos científicos \citep{travis2007,millman2011,perez2011}.
...
manipulación y análisis de datos; scikit-learn \citep{sklearn2011}, con
...
distribución de Python orientada específicamente para realizar ciencia de
datos, aprendizaje automático e investigaciones científicas; facilitando la
instalación del intérprete y las múltiples librerías en diferentes plataformas
y sistemas operativos.

En este capítulo expondremos cómo se desarrolló el proyecto Fatiando a Terra,
del cual formo parte del grupo de desarrolladores, construyendo herramientas
...
mundo.
La utilización de \texttt{fatiando} por otros investigadores e investigadoras
deriva a su vez en un ciclo de retroalimentación: quienes comienzan siendo
usuarios realizan colaboraciones.
De esta forma \texttt{} comienza a alojar implementaciones de métodos
...
Harmonica cuenta con una implementación del método de \citet{nagy2000}
...
de ellos.
Harmonica ofrece un accesor de Xarray para poder calcular los campos
...
]{chapters/fatiando-examples/harmonica-prism-layer.py}
...
Harmonica ofrece además algunas otras funcionalidades de procesado de
...
Pooch nos ofrece herramientas para descargar datos científicos alojados
...
Fatiando como Harmonica y Verde.
Además, librerías de Python con aplicaciones más amplias han incluido
a Pooch dentro de sus dependencias, por ejemplo Xarray
