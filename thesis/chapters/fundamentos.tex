...
El vector aceleración de gravedad terrestre $\mathbf{g}$ se puede obtener
a partir del potencial $W$ mediante la
ecuación~\ref{eq:potencial-gravitatorio-definicion}.
A partir de su definición es posible deducir que $\mathbf{g}(\mathbf{p})$ es un
vector normal a la superficie equipotencial que pasa por el mismo punto
$\mathbf{p}$.
...
La superficie
equipotencial que coincide con el nivel medio del mar se define como el
\emph{geoide}:
