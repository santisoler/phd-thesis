...
Definiremos entonces al \emph{vector del disturbio de gravedad} $\delta
\mathbf{g}$ (\emph{gravity disturbance vector} en ingles) como la diferencia
entre el vector \emph{gravedad} en el punto $\mathbf{p}$ y el vector
\emph{gravedad normal} calculado en el mismo punto $\mathbf{p}$:

\begin{equation}
    \delta \mathbf{g}(\mathbf{p}) =
        \mathbf{g}(\mathbf{p}) - \mathbf{\gamma}(\mathbf{p}).
...
$\delta g$, definido como la diferencia entre el módulo del vector gravedad
y el módulo del vector gravedad normal en el mismo punto $\mathbf{p}$
...
módulo del \emph{vector disturbio de gravedad} $\delta g$
