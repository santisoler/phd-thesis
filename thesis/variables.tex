...
\newcommand{\PDFKeywords}{
    geofísica, gravimetría, tesseroides, fuentes equivalentes, Python,
    open-source, Fatiando a Terra
}

% Define version and publication date (should be hard coded before submission)
\newcommand{\ThesisVersion}{1.0.0}
\DTMsavedate{publication}{2021-10-29}
...
\newcommand{\HarmonicaVersion}{\href{https://www.fatiando.org/harmonica/v0.3.3/}{v0.3.3}}
